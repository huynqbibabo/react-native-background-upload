...
class ModelTranscodeInput {
  ...
  fun createInputDataForTranscode(notificationId: Int, filePath: String, chunkSize: Int): Data {
    return workDataOf(
...
class ModelClearTask {
  ...
  fun createInputDataForClearTask(workId: Int, filename:String, url: String?, method: String?, auth: String?, data: String?): Data {
    return workDataOf(
